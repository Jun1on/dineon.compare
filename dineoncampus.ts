...
async function getMenu(school: string, date: string) {
    let data = {}
...
let cache = {}
async function getMenuCached(school: string, date: string) {
...
async function getDiff(school: string, beforeDate: string, nowDate: string) {
    let diff = {}
    let same = {}
